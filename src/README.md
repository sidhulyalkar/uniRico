# uniRico v0.17.0 readable source

The opening rules legend is rendered as a dark rainbow bottom ribbon while Play / Levels remain centered. `tests/menu-rules.js` protects this menu hierarchy.
...
`render-hud.js::$T()` draws the dark rainbow onboarding ribbon using the same cloud/ring/badge language seen in play.
